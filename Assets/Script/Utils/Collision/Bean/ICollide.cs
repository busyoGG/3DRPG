...
public class ICollide
{
    ...
    public virtual bool Interactive(CapsuleData other, out Vector3 point) { point = CollideUtils._minValue; return false; }
    ...
    public virtual Vector3 GetNormal(CapsuleData data2, out float len) { len = 0; return Vector3.zero; }
}
